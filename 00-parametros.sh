...
# Versão atualizada para 9.4.5 no dia 27/02/2020 - verificar arquivo CHANGELOG
...
# Versão atualizada para 9.4+2.4 no dia 27/02/2020 - verificar arquivo CHANGELOG
...
# Versão atualizada para 2.5.2 no dia 27/02/2020 - verificar arquivo CHANGELOG
...
# Versões novas atualizadas no dia 27/02/2020 - verificar arquivo CHANGELOG
...
OCSAGENTTOOLSX64="https://github.com/OCSInventory-NG/Packager-for-Windows/releases/download/2.6/OCS-Windows-Packager-2.6.zip"
